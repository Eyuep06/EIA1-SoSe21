...
var UnterschiedEuropaProz:number = (emissionEuropa18 - emissionEuropa08) / emissionEuropa08 * 100;
var UnterschiedAsienProz:number = (emissionAsien18 - emissionAsien08) / emissionAsien08 * 100;
var UnterschiedAfrikaProz:number = (emissionAfrika18 - emissionAfrika08) / emissionAfrika08 * 100;
var UnterschiedAustralienProz:number = (emissionAustralien18 - emissionAustralien08) / emissionAustralien08 * 100;
var UnterschiedSamericaProz:number = (emissionSamerica18 - emissionSamerica08) / emissionSamerica08 * 100;
var UnterschiedNamericaProz:number = (emissionNamerica18 - emissionNamerica08) / emissionNamerica08 * 100;

var UnterschiedEuropaKg:number = (emissionEuropa18 - emissionEuropa08);
var UnterschiedAsienKg:number = (emissionAsien18 - emissionAsien08);
var UnterschiedAfrikaKg:number = (emissionAfrika18 - emissionAfrika08);
var UnterschiedAustralienKg:number = (emissionAustralien18 - emissionAustralien08);
var UnterschiedSamericaKg:number = (emissionSamerica18 - emissionSamerica08);
var UnterschiedNamericaKg:number = (emissionNamerica18 - emissionNamerica08);
